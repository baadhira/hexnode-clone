...
//           <div className="feature-header" onClick={() => toggleSection(feature.id)}>
...
//           <div className={`feature-content ${activeSection === feature.id ? 'active' : ''}`}>
      ...
      {features.map((feature) => (
        ...
        //   className="feature-header"
          ...
          <div
            ...
            style={{
              transformOrigin: activeSection === feature.id ? 'bottom' : 'top', // Dynamic origin
            }}
          >
            <div className="feature-body">
              <div className="feature-text">
